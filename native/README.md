...
- a bootstrap/release entrypoint pair that can create, retain, and later restore a native `CAMetalLayer` host surface handle while reporting initial drawable size and content scale
